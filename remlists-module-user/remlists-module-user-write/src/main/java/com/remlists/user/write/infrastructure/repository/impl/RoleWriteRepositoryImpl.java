...
public class RoleWriteRepositoryImpl extends RemListBaseRepository<Role,
    ...
    private RoleMapperStruct roleMapperS;
    private UserMapperStruct userMapperS;
    ...
    public Optional<Role> findByRoleName(RoleName roleName) {
        ...
        RoleNameJPA roleNameJPA =  roleMapperS.INSTANCE.RoleNameToRoleNameJPA( roleName );
        ...
        return  Optional.of(   roleMapperS.INSTANCE.roleJPAToRole( byRole.orElseThrow() ) );
    ...
    public Role save(Role role) {
        ...
        RoleJPA roleJPA = roleMapperS.INSTANCE.roleToRoleJPA(role);

        Set<User> users = role.getUsers();
        Set<UserJPA> userJPAS = userMapperS.INSTANCE.userSetToUserJPASet(users);

        userJPAS.stream().forEach(userJPA -> userJPA.addRole(roleJPA));

        RoleJPA rolePersisted = repository.save(roleJPA);

        return roleMapperS.INSTANCE.roleJPAToRole(rolePersisted);
    }
