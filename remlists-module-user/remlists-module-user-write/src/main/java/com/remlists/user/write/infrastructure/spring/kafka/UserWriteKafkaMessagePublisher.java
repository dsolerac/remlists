package com.remlists.user.write.infrastructure.spring.kafka;
...
@Component(userWriteKafkaMessagePublisher)
public class UserWriteKafkaMessagePublisher<T extends Event> implements MessagePublisher<T> {

    private Logger LOG = LoggerFactory.getLogger(UserWriteKafkaMessagePublisher.class);
    ...
    public UserWriteKafkaMessagePublisher(KafkaTemplate kafkaTemplate,
