...
@SpringBootTest
public class RemListCommandRepositoryTest {

    private Logger LOG = LoggerFactory.getLogger(RemListCommandRepositoryTest.class);


    @Autowired
    @Qualifier(listReadCommandRepositoryJPA)
